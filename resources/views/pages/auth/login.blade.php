...
@section('title', 'Admin Login - fociloans')
@section('description', 'Secure login portal for FOCI Loans administrators')
@section('keywords', 'admin login, secure access, FOCI Loans admin')
