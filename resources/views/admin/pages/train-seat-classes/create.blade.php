...
@section('content-auth')
        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0 px-3">
                    <h5 class="mb-0">Tạo hạng ghế tàu mới</h5>
                </div>
                <div class="card-body pt-4 p-3">
                    @include('admin.pages.components.success-error')

                    <form action="{{ route('admin.train-seat-classes.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_seats" id="total_seats" class="form-control @error('total_seats') is-invalid @enderror"
                                        value="{{ old('total_seats') }}" placeholder="50" min="1" required>
                                    @error('total_seats')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="available_seats" id="available_seats" class="form-control @error('available_seats') is-invalid @enderror"
                                        value="{{ old('available_seats') }}" placeholder="50" min="0" required>
    ...
    <script>
        ...
        document.getElementById('total_seats').addEventListener('input', function() {
            ...
            if (availableSeatsInput.value === '' || parseInt(availableSeatsInput.value) > totalSeats) {
