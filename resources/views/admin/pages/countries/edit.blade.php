        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0 px-3">
                    <h5 class="mb-0">Chỉnh sửa quốc gia</h5>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror"
                                    value="{{ old('code', $country->code) }}" placeholder="VD: LAO, THA, VNM" maxlength="10" required>
                                @error('code')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name', $country->name) }}" placeholder="VD: Laos, Thailand" required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="local_name" id="local_name" class="form-control @error('local_name') is-invalid @enderror"
                                    value="{{ old('local_name', $country->local_name) }}" placeholder="VD: ລາວ, ไทย">
                                @error('local_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="timezone" id="timezone" class="form-control @error('timezone') is-invalid @enderror">
                                    ...
                                    <option value="Asia/Vientiane" {{ old('timezone', $country->timezone) == 'Asia/Vientiane' ? 'selected' : '' }}>Asia/Vientiane (UTC+7)</option>
                                    <option value="Asia/Bangkok" {{ old('timezone', $country->timezone) == 'Asia/Bangkok' ? 'selected' : '' }}>Asia/Bangkok (UTC+7)</option>
                                    <option value="Asia/Ho_Chi_Minh" {{ old('timezone', $country->timezone) == 'Asia/Ho_Chi_Minh' ? 'selected' : '' }}>Asia/Ho_Chi_Minh (UTC+7)</option>
                                    <option value="Asia/Phnom_Penh" {{ old('timezone', $country->timezone) == 'Asia/Phnom_Penh' ? 'selected' : '' }}>Asia/Phnom_Penh (UTC+7)</option>
                                </select>
                                @error('timezone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="currency_code" id="currency_code" class="form-control @error('currency_code') is-invalid @enderror"
                                    value="{{ old('currency_code', $country->currency_code) }}" placeholder="VD: LAK, THB, VND" maxlength="10">
                                @error('currency_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="currency_symbol" id="currency_symbol" class="form-control @error('currency_symbol') is-invalid @enderror"
                                    value="{{ old('currency_symbol', $country->currency_symbol) }}" placeholder="VD: ₭, ฿, ₫" maxlength="10">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $country->is_active) ? 'checked' : '' }}>
