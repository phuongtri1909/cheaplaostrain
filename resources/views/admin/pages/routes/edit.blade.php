        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0 px-3">
                    <h5 class="mb-0">Chỉnh sửa tuyến đường</h5>
                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror"
                                        value="{{ old('code', $route->code) }}" placeholder="VD: VTE-BKK, LNT-HUE" required>
                                    @error('code')
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                        value="{{ old('name', $route->name) }}" placeholder="VD: Vientiane - Bangkok" required>
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.1" name="distance_km" id="distance_km" class="form-control @error('distance_km') is-invalid @enderror"
                                        value="{{ old('distance_km', $route->distance_km) }}" placeholder="VD: 654.5" min="0">
                                    @error('distance_km')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="estimated_duration_minutes" id="estimated_duration_minutes" class="form-control @error('estimated_duration_minutes') is-invalid @enderror"
                                        value="{{ old('estimated_duration_minutes', $route->estimated_duration_minutes) }}" placeholder="VD: 720 (12 giờ)" min="0">
