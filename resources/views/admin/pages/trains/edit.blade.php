        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0 px-3">
                    <h5 class="mb-0">Chỉnh sửa tàu</h5>
                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="train_number" id="train_number" class="form-control @error('train_number') is-invalid @enderror"
                                        value="{{ old('train_number', $train->train_number) }}" placeholder="VD: LT001, EXP-VTE-BKK" required>
                                    @error('train_number')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="route_id" id="route_id" class="form-control @error('route_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($routes as $route)
                                            <option value="{{ $route->id }}" {{ old('route_id', $train->route_id) == $route->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="train_type" id="train_type" class="form-control @error('train_type') is-invalid @enderror"
                                        value="{{ old('train_type', $train->train_type) }}" placeholder="VD: Tốc hành, Thường, Cao tốc" required>
                                    @error('train_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="operator" id="operator" class="form-control @error('operator') is-invalid @enderror"
                                        value="{{ old('operator', $train->operator) }}" placeholder="VD: Lao Railway, Thai SRT" required>
                                    @error('operator')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
