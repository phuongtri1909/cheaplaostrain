        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0 px-3">
                    <h5 class="mb-0">Chỉnh sửa ga tàu</h5>
                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror"
                                        value="{{ old('code', $station->code) }}" placeholder="VD: VTE-MAIN, BOT-CENTRAL" required>
                                    @error('code')
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                        value="{{ old('name', $station->name) }}" placeholder="VD: Vientiane Railway Station" required>
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="administrative_unit_id" id="administrative_unit_id" class="form-control @error('administrative_unit_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($administrativeUnits as $unit)
                                            <option value="{{ $unit->id }}" {{ old('administrative_unit_id', $station->administrative_unit_id) == $unit->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" id="address" rows="3" class="form-control @error('address') is-invalid @enderror"
                                        placeholder="Nhập địa chỉ chi tiết của ga tàu">{{ old('address', $station->address) }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.000001" name="latitude" id="latitude" class="form-control @error('latitude') is-invalid @enderror"
                                        value="{{ old('latitude', $station->latitude) }}" placeholder="VD: 17.9757">
                                    @error('latitude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.000001" name="longitude" id="longitude" class="form-control @error('longitude') is-invalid @enderror"
                                        value="{{ old('longitude', $station->longitude) }}" placeholder="VD: 102.6331">
                                    @error('longitude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
