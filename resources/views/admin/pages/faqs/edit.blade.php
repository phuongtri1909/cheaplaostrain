        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0 px-3">
                    <h5 class="mb-0">Chỉnh sửa câu hỏi thường gặp</h5>
                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="order" id="order" class="form-control @error('order') is-invalid @enderror"
                                        value="{{ old('order', $faq->order) }}" min="0" placeholder="Thứ tự hiển thị">
                                    @error('order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="question" id="question"
                                        ...
                                        required placeholder="Nhập câu hỏi">{{ old('question', $faq->question) }}</textarea>
                                    @error('question')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
