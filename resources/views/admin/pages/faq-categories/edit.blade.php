        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0 px-3">
                    <h5 class="mb-0">Chỉnh sửa danh mục FAQ</h5>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="order" id="order" class="form-control @error('order') is-invalid @enderror"
                                        value="{{ old('order', $faqCategory->order) }}" min="0" placeholder="Thứ tự hiển thị">
                                    @error('order')
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror"
                                        value="{{ old('slug', $faqCategory->slug) }}" placeholder="Slug URL (tùy chọn)">
                                    @error('slug')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        value="{{ old('name', $faqCategory->name) }}" required placeholder="Nhập tên danh mục">
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12 mt-4">
                                <div class="form-check">
                                    <input type="checkbox" name="is_active" id="is_active" class="form-check-input" value="1" {{ old('is_active', $faqCategory->is_active) ? 'checked' : '' }}>
