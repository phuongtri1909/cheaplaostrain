        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0 px-3">
                    <h5 class="mb-0">Chỉnh sửa giá lịch trình</h5>
                </div>
                <div class="card-body pt-4 p-3">
                    @include('admin.pages.components.success-error')

                    <form action="{{ route('admin.schedule-prices.update', $schedulePrice->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="schedule_id" id="schedule_id" class="form-control @error('schedule_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($schedules as $schedule)
                                            <option value="{{ $schedule->id }}" {{ old('schedule_id', $schedulePrice->schedule_id) == $schedule->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="seat_class_id" id="seat_class_id" class="form-control @error('seat_class_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($seatClasses as $seatClass)
                                            <option value="{{ $seatClass->id }}" {{ old('seat_class_id', $schedulePrice->seat_class_id) == $seatClass->id ? 'selected' : '' }}>
                                                {{ $seatClass->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="price" id="price" class="form-control @error('price') is-invalid @enderror"
                                        value="{{ old('price', $schedulePrice->price) }}" placeholder="0.00" min="0" required>
                                    @error('price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="currency" id="currency" class="form-control @error('currency') is-invalid @enderror"
                                        value="{{ old('currency', $schedulePrice->currency) }}" placeholder="LAK">
                                    @error('currency')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="effective_from" id="effective_from" class="form-control @error('effective_from') is-invalid @enderror"
                                        value="{{ old('effective_from', $schedulePrice->effective_from?->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="effective_until" id="effective_until" class="form-control @error('effective_until') is-invalid @enderror"
                                        value="{{ old('effective_until', $schedulePrice->effective_until?->format('Y-m-d')) }}">
